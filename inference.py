# (I): Predict the PM10 level and the error term for each period, derive confidnce intervals in the evaluation
# periods, make violinplots for residuals in the training and test period
#   in train and test periods
# (II): Compute confidence intervals
# (III): Plot yhat and the confidence bounds: evaluation plot
...
# (I) Predict yhat, uhat for each period derive confidence bounds
...
# confidence bounds
#cb_eval15_lower = dict()
#cb_eval15_upper = dict()
#cb_eval17_lower = dict()
#cb_eval17_upper = dict()
...
# (I.3): Confidence bounds
# eval15 window
cb_eval15_lower = yhat_eval15_window+uhat_train.quantile(q=0.025)
cb_eval15_upper = yhat_eval15_window+uhat_train.quantile(q=0.975)
# eval17 window
cb_eval17_lower = yhat_eval17_window+uhat_train.quantile(q=0.025)
cb_eval17_upper = yhat_eval17_window+uhat_train.quantile(q=0.975)


# (I.4): Vilon plot of residuals
# Rename for plotting
...
# (II): Make evaluation plots
# (II.1): Restrict window for plotting
...
cb_eval15_lower_r = cb_eval15_lower['2015-11-05':'2015-11-11']
cb_eval15_upper_r = cb_eval15_upper['2015-11-05':'2015-11-11']
cb_eval17_lower_r = cb_eval17_lower['2017-01-20':'2017-01-29']
cb_eval17_upper_r = cb_eval17_upper['2017-01-20':'2017-01-29']
# (II.2): Plot
plt.clf()
plt.rc('font',family='serif')
plt.rc('xtick', labelsize=12)
...
d = 0.02
# Time array for setting labels and fill between confidence bounds
...
ax1.fill_between(tickarray15, cb_eval15_lower_r['Csepel'], cb_eval15_upper_r['Csepel'], color=boundcolor, alpha=balpha)
...
ax2.fill_between(tickarray17, cb_eval17_lower_r['Csepel'], cb_eval17_upper_r['Csepel'], color=boundcolor, alpha=balpha)
...
ax3.fill_between(tickarray15, cb_eval15_lower_r['Erzsebet'], cb_eval15_upper_r['Erzsebet'], color=boundcolor, alpha=balpha)
...
ax4.fill_between(tickarray17, cb_eval17_lower_r['Erzsebet'], cb_eval17_upper_r['Erzsebet'], color=boundcolor, alpha=balpha)
...
ax5.fill_between(tickarray15, cb_eval15_lower_r['Gergely'], cb_eval15_upper_r['Gergely'], color=boundcolor, alpha=balpha)
...
ax6.fill_between(tickarray17, cb_eval17_lower_r['Gergely'], cb_eval17_upper_r['Gergely'], color=boundcolor, alpha=balpha)
...
ax7.fill_between(tickarray15, cb_eval15_lower_r['Gilice'], cb_eval15_upper_r['Gilice'], color=boundcolor, alpha=balpha)
...
ax8.fill_between(tickarray17, cb_eval17_lower_r['Gilice'], cb_eval17_upper_r['Gilice'], color=boundcolor, alpha=balpha)
...
ax9.fill_between(tickarray15, cb_eval15_lower_r['Korakas'], cb_eval15_upper_r['Korakas'], color=boundcolor, alpha=balpha)
...
ax10.fill_between(tickarray17, cb_eval17_lower_r['Korakas'], cb_eval17_upper_r['Korakas'], color=boundcolor, alpha=balpha)
...
ax11.fill_between(tickarray15, cb_eval15_lower_r['Kosztolanyi'], cb_eval15_upper_r['Kosztolanyi'], color=boundcolor, alpha=balpha)
...
ax12.fill_between(tickarray17, cb_eval17_lower_r['Kosztolanyi'], cb_eval17_upper_r['Kosztolanyi'], color=boundcolor, alpha=balpha)
...
ax13.fill_between(tickarray15, cb_eval15_lower_r['Pesthidegkut'], cb_eval15_upper_r['Pesthidegkut'], color=boundcolor, alpha=balpha)
...
ax14.fill_between(tickarray17, cb_eval17_lower_r['Pesthidegkut'], cb_eval17_upper_r['Pesthidegkut'], color=boundcolor, alpha=balpha)
...
ax15.fill_between(tickarray15, cb_eval15_lower_r['Szena'], cb_eval15_upper_r['Szena'], color=boundcolor, alpha=balpha)
...
ax16.fill_between(tickarray17, cb_eval17_lower_r['Szena'], cb_eval17_upper_r['Szena'], color=boundcolor, alpha=balpha)
